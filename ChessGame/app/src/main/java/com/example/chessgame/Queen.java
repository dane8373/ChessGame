...
public class Queen extends Piece {
    public Queen(int color, int row, int column, ImageView square, ChessBoard board) {
    ...
    public void setPieceImage() {
        if (mColor == WHITE) {
            if(ChessBoard.getSquareColor(row, col) == WHITE) {
                squareImage.setImageResource(R.drawable.white_queen_white);
            }
            else {
                squareImage.setImageResource(R.drawable.white_queen_grey);
            }
        }
        else {
            if(ChessBoard.getSquareColor(row, col) == WHITE) {
                squareImage.setImageResource(R.drawable.black_queen_white);
            }
            else {
                squareImage.setImageResource(R.drawable.black_queen_grey);
            }
        }
    }
    ...
    public void makeRed() {
        if (mColor == WHITE) {
            squareImage.setImageResource(R.drawable.white_queen_red);
        }
        else {
            squareImage.setImageResource(R.drawable.black_queen_red);
        }
    }
    ...
    public void makeGreen() {
        if (mColor == WHITE) {
            squareImage.setImageResource(R.drawable.white_queen_green);
        }
        else {
            squareImage.setImageResource(R.drawable.black_queen_green);
        }
    }
